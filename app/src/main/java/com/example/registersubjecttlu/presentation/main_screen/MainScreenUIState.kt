...
sealed interface MainScreenUIState {
    ...
    data class RemoveRegisterSuccess(val message: String): MainScreenUIState
    data class RemoveRegisterError(val message: String): MainScreenUIState
    ...
    data class LoadSemesterSuccess(val message: String): MainScreenUIState
}